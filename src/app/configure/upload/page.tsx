...
function page() {
  ...
  const onDropRejected = (rejectedFiles: FileRejection[]) => {
    ...
    toast({
      ...
      description: "Pleasse choose  PNG,JPG or JPEG image instead",
      variant: "destructive",
    });
  };
  ...
  return (
    <div
      className={cn(
        "relative h-full flex-1 my-6 w-full rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:rounded-2xl flex justify-center flex-col items-center",
        {
